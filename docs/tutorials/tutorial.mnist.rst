...
.. code-block:: console
    ...
    python grpc_aggregator.py --plan_path federations/plans/mnist_a.yaml --disable_client_auth --ca=files/grpc/localhost.crt --certificate=files/grpc/some.machine.intel.com.crt --private_key=files/grpc/private/some.machine.intel.com.key
...
.. code-block:: console
    ...
    python grpc_aggregator.py --plan_path federations/plans/mnist_a.yaml --ca=files/grpc/localhost.crt --certificate=files/grpc/some.machine.intel.com.crt --private_key=files/grpc/private/some.machine.intel.com.key
